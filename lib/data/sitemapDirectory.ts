...
const DESTINATION_PARK_ROWS: Record<Country, string[]> = {
  kenya: [
    ...
    "Chyulu Hills National Park|chyulu-hills-national-park",
    "Buffalo Springs National Reserve|buffalo-springs-national-reserve",
  ],
  tanzania: [
    ...
    "Zanzibar|zanzibar",
    "Selous / Nyerere National Park|selous-nyerere-national-park",
  ...
  uganda: [
    ...
    "Jinja - Source of the Nile|jinja-source-of-the-nile",
    "Sipi Falls|sipi-falls",
  ],
  rwanda: [
    ...
    "Lake Kivu|lake-kivu",
    "Gishwati-Mukura National Park|gishwati-mukura-national-park",
