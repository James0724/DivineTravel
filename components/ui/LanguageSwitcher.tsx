...
export default function LanguageSwitcher({
  ...
  const coords = useFloatingDropdown(open, triggerRef, dropDirection, 260);
  ...
  const filtered = useMemo(() => {
    ...
    return routing.locales.filter((code) => {
      ...
      return (
        ...
        meta.nativeName.toLowerCase().includes(q)
      );
    });
  }, [query]);
          ...
          <AnimatePresence>
            {open && coords && (
              <motion.div
                ...
                className="z-[300] overflow-hidden rounded-xl border border-bone-ink/12 bg-white shadow-[0_12px_40px_-8px_rgba(0,0,0,0.18)] ring-1 ring-black/5"
              >
                    ...
                    {filtered.map((code) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {active && (
                            <span className="shrink-0 text-[9px] text-bone-clay">
                              ✓
                            </span>
                          )}
                        </button>
