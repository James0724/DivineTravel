...
function CommentItem({ comment, replies, onReply }: CommentItemProps) {
  return (
    <div className="space-y-4">
      ...
      <div className="flex gap-4">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-baseline gap-3 flex-wrap mb-2">
            <span className="font-sans font-semibold text-[14px] text-bone-ink">
              {comment.name}
            </span>
          ...
          {comment.adminReply && (
            <div
              ...
              style={{
                borderLeft: "3px solid #9d4519",
                background: "rgba(157,69,25,0.05)",
              }}
            >
      ...
      {replies.length > 0 && (
        <div
          className="ml-14 space-y-4 pl-4"
          style={{ borderLeft: "1px solid rgba(31,29,24,0.14)" }}
        >
          {replies.map((reply) => (
            <div key={reply._id} className="flex gap-3">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-baseline gap-3 flex-wrap mb-1.5">
                  <span className="font-sans font-semibold text-[13px] text-bone-ink">
                    {reply.name}
                  </span>
                  <span className="font-mono text-[10px] uppercase tracking-[0.1em] text-bone-muted">
        ...
        <div ref={formRef}>
          {replyTo && (
            <div
              ...
              style={{
                background: "rgba(157,69,25,0.07)",
                border: "1px solid rgba(157,69,25,0.2)",
              }}
            >
              <span className="font-sans text-[13px] text-bone-ink/70">
                Replying to{" "}
                <strong className="text-bone-ink">{replyTo.name}</strong>
              </span>
              <button
          ...
          <p className="font-sans text-[13px] text-bone-muted mb-6 leading-[1.6]">
            ...
            <span className="text-bone-clay">*</span>. Please keep discussions
            respectful — see our{" "}
              ...
              <textarea
                ...
                onChange={(e) => {
                  ...
                  if (errors.commentBody)
                    setErrors((er) => ({ ...er, commentBody: undefined }));
                }}
              ...
              <label className="flex items-start gap-3 cursor-pointer group">
                <input
                  ...
                  onChange={(e) =>
                    setForm((f) => ({
                      ...f,
                      subscribeToReplies: e.target.checked,
                    }))
                  }
