    ...
    <>
        ...
        <div className="container-site">
          ...
          <div className="mt-14 sm:mt-20 flex gap-10 xl:gap-14 items-start">
            ...
            {data.featureParks.map((park) => (
              ...
              >
                {/* Image */}
                <Reveal variant={park.flip ? 'slideRight' : 'slideLeft'}>
                  <div
                ...
                {/* Content */}
                <Reveal variant={park.flip ? 'slideLeft' : 'slideRight'} delay={0.1}>
      ...
      <section className="py-20 sm:py-28 bg-bone-paper">
        <div className="container-site">
          ...
          <Stagger className={`grid gap-[28px] ${data.moreParksGridCols ?? 'grid-cols-1 md:grid-cols-2 xl:grid-cols-3'}`}>
      ...
      <section className="bg-[var(--bg)] py-[76px] xl:py-[120px]">
        <div className="container-site">
          ...
          <Stagger
            className="grid grid-cols-1 gap-px border border-[var(--line)] bg-[var(--line)] md:grid-cols-2 xl:grid-cols-4"
          >
        ...
        <div className="container-site">
          ...
          <Stagger className="grid grid-cols-1 sm:grid-cols-2 gap-6" stagger={0.12}>
            {data.bestTime.seasons.map((s) => (
              <RevealItem key={s.badge} className="p-[40px] border border-bone-paper/15">
