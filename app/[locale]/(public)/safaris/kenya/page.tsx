...
const faqs = [
  {
    q: "What is the best time to visit Kenya for safari?",
    a: "June to October — the dry season — offers the best game viewing overall. For the Great Wildebeest Migration in the Masai Mara, aim for July to October.",
  },
  {
    q: "How much do Kenya safari packages cost?",
    a: "As a rough guide per person per day: budget from $150–$250, mid-range $250–$450, and luxury $600–$1,200. We'll send a tailored quote based on your dates and preferences.",
  },
  {
    q: "Is Kenya safe for safari tours?",
    a: "Yes. Kenya's national parks are professionally managed, and we add extra peace of mind through experienced guides and secure transportation throughout.",
  },
  {
    q: "Can I customise my Kenya safari package?",
    a: "Absolutely — every package can be tailored to your budget, dates, safari style and accommodation level. Nothing here is fixed.",
  },
  {
    q: "What animals will I see on safari in Kenya?",
    a: "Expect lions, elephants, buffalo, leopards, rhinos, cheetahs, giraffes, zebras, wildebeest, hippos, crocodiles, hyenas and a great deal more.",
  },
  {
    q: "Are your safari vehicles comfortable?",
    a: "Yes — our Land Cruisers have a pop-up roof, charging ports, a cooler box, binoculars and a guaranteed window seat for every guest.",
  },
  {
    q: "Can you combine a Kenya safari with Tanzania?",
    a: "Yes — our Kenya–Tanzania combined safaris are among our most popular trips, pairing the Mara with the Serengeti, Ngorongoro and Tarangire.",
  },
];
    ...
    <>
      ...
      <CountrySafariPage
        ...
        hero={{
          ...
          title: "Kenya safari packages 2026/2027.",
          description:
            "Masai Mara game drives, Amboseli elephant watching, Big Five in Tsavo and Samburu rare species — every Kenya itinerary tailored to your dates, party size and budget.",
          stats: [
        ...
        packages={{
          ...
          description:
            "Designed for optimal wildlife sightings, comfort and value. Browse by trip length — then tell us your dates and we'll right-size any of these around your party and budget.",
        ...
        choose={{
          ...
          description:
            "Tell us the animal or atmosphere you're chasing and we'll build the route around it — combining three to five parks into one seamless itinerary.",
          cells: [
          ...
          items: [
            {
              ...
              body: "Certified, knowledgeable and experienced in wildlife tracking — the single biggest factor in a great safari.",
            },
            {
              n: "02",
            ...
            {
              n: "03",
              title: "Comfortable 4×4s",
              body: "Pop-up roofs, guaranteed window seats, charging ports, cooler boxes and binoculars in every vehicle.",
            },
            {
              n: "04",
            ...
            },
            {
              ...
              body: "Authentic experiences rooted in regional insight and years of on-the-ground knowledge.",
            },
          ],
        }}
        bestTime={{
          intro:
            "Kenya is rewarding all year — the best months simply depend on what you want to see. We'll tune your dates around the wildlife you're chasing.",
          seasons: [
            {
        ...
        tailor={{
          ...
          description:
            "Your safari should be too. Tell us your travel dates and we'll build your perfect trip — at whatever level of comfort and pace suits you.",
          points: [
            {
              ic: "i",
            ...
            {
              ic: "ii",
              b: "Luxury safari holidays",
              s: "exclusive lodges & private guides",
            },
            {
              ic: "iii",
              b: "Family & honeymoon safaris",
              s: "tailored pace, the right camps",
            },
            {
              ic: "iv",
          ...
          image:
            "https://images.pexels.com/photos/13932855/pexels-photo-13932855.jpeg?auto=compress&cs=tinysrgb&w=900&q=80",
