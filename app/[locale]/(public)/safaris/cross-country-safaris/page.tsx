...
const whyCircuit = [
  {
    n: "01",
    title: "Two ecosystems, one trip",
    body: "Combine the open Kenyan savannah with Tanzania's Serengeti — the full wildebeest migration story from calving to river crossings.",
  },
  {
    n: "02",
    title: "No flights wasted",
    body: "We design routes that minimise doubling back — fly into Nairobi, out of Entebbe, or reverse, depending on where your circuit ends.",
  },
  {
    n: "03",
    title: "Seamless border logistics",
    body: "We handle border crossings, paperwork, permits (including gorilla), park fees and transfers so you just experience the wildlife.",
  },
  {
    n: "04",
    title: "One operator, one plan",
    body: "Booking a multi-country circuit through one operator means no gaps, no miscommunication and one point of contact for everything.",
  },
  {
    n: "05",
    title: "Best of three countries",
    body: "Big Five in Kenya, the Migration in Tanzania, and the world's most powerful primate encounter in Uganda — all in a single itinerary.",
  },
  {
    n: "06",
    title: "Budget, mid-range & luxury",
    body: "Every circuit is available across all three accommodation tiers — we match the camps and lodges to your budget and comfort level.",
  },
];
...
const tailorPoints = [
  {
    ic: "i",
    b: "Kenya + Tanzania",
    s: "Mara, Serengeti, Ngorongoro, Amboseli",
  },
  { ic: "ii", b: "Kenya + Uganda", s: "Masai Mara + Bwindi gorilla trekking" },
  {
    ic: "iii",
    b: "Tanzania + Uganda",
    s: "Serengeti + Bwindi or Queen Elizabeth",
  },
  {
    ic: "iv",
    b: "Full East Africa circuit",
    s: "All three countries, 10–16 days",
  },
  {
    ic: "v",
    b: "Migration + gorillas",
    s: "River crossings + Bwindi — the pinnacle",
  },
];
...
const faqs = [
  {
    q: "Which countries do cross-country safaris cover?",
    a: "Our multi-country circuits combine Kenya, Tanzania and Uganda in various combinations — two-country circuits starting from around 7 days, and full three-country trips of 12–16 days.",
  },
  {
    q: "How do border crossings work?",
    a: "We handle all border crossing logistics — both land crossings and connecting flights between countries. You simply travel; we take care of the paperwork, permits and transfers.",
  },
  {
    q: "How long does a cross-country safari need to be?",
    a: "A Kenya–Tanzania combination is meaningful from 7 days. A Kenya–Uganda circuit works from 6 days. A full three-country East Africa trip is best at 12–16 days.",
  },
  {
    q: "Can I combine gorilla trekking with a Kenya safari?",
    a: "Yes — this is one of our most popular combinations. Typically 3–4 days in Kenya (Masai Mara, Amboseli) and 3–4 days in Uganda (Bwindi gorilla trek, Queen Elizabeth NP).",
  },
  {
    q: "What is the Great Migration circuit?",
    a: "The classic circuit follows the wildebeest: calving season in Tanzania's Ndutu (Jan–Mar), then north through the Serengeti to the Masai Mara river crossings (Jul–Oct). We design the exact parks around your travel dates.",
  },
  {
    q: "How much does a cross-country safari cost?",
    a: "A two-country circuit typically starts from $2,500 per person in budget lodges, $3,500–5,000 in mid-range, and $7,000+ in luxury. Three-country trips are priced by day and lodge tier.",
  },
  {
    q: "Is it possible to combine a beach holiday with a cross-country safari?",
    a: "Absolutely. Zanzibar is a natural ending to a Kenya–Tanzania circuit, adding 3–4 days of Indian Ocean beach time after the wildlife. We arrange the short flight from the mainland.",
  },
];
  ...
  return (
    <>
            ...
            <div className="flex-1 min-w-0">
              <div className="section-hd">
                ...
                <p
                  ...
                  style={{ maxWidth: "56ch" }}
                >
                  Each circuit is designed to combine the best of two or three
                  countries without unnecessary transfers — tell us your dates
                  and we tune every detail.
                </p>
              </div>

              {safaris.length === 0 ? (
                <div className="py-16 text-center">
                  <p className="font-serif text-[32px] text-bone-ink mb-4">
                    Bespoke circuits available
                  </p>
                  <p
                    className="text-sm text-bone-muted mb-8 mx-auto"
                    style={{ maxWidth: "52ch" }}
                  >
                    Our cross-country itineraries are tailor-made to your dates
                    and preferences. Tell us where you want to go and we&apos;ll
                    build the perfect multi-country circuit.
                  </p>
      ...
      <WhyGrid
        ...
        heading={
          <>
            The <em className="italic text-bone-clay">full</em>
            <br />
            picture.
          </>
        }
      ...
      <SectionFaq
        ...
        heading={
          <>
            Before you <em className="italic text-bone-clay">plan</em>.
          </>
        }
        contactNote={
          <>
      ...
      <CtaBand
        ...
        heading={
          <>
            Let&apos;s build your East Africa{" "}
            <em style={{ fontStyle: "italic", color: "#f4d4a8" }}>circuit</em>.
          </>
        }
