...
const faqs = [
  {
    q: "What is the best time to visit Tanzania for safari?",
    a: "The dry season from June to October is ideal for wildlife viewing across all parks. For the calving season and Ndutu, visit January to March. The Serengeti offers year-round wildlife.",
  },
  {
    q: "How much do Tanzania safari packages cost?",
    a: "Budget from $200–$350 per person per day, mid-range $350–$600, and luxury $800–$1,500. Tanzania's park fees are higher than Kenya's. We'll send a tailored quote.",
  },
  {
    q: "Is Tanzania safe for tourists?",
    a: "Yes. Tanzania is one of Africa's most stable and welcoming countries, with a long tradition of professional safari tourism.",
  },
  {
    q: "Can I see the Great Migration in Tanzania?",
    a: "Yes — the wildebeest spend most of the year in Tanzania's Serengeti. The calving season is January–February in the Ndutu area; the river crossings shift to Kenya's Mara from July.",
  },
  {
    q: "What is the difference between Serengeti and Ngorongoro?",
    a: "The Serengeti is a vast open ecosystem ideal for the migration and big cats. Ngorongoro Crater is a self-contained caldera with the highest density of wildlife in Africa — including rhino.",
  },
  {
    q: "Can I combine Tanzania with a Zanzibar beach holiday?",
    a: "Absolutely — a Zanzibar extension is one of our most popular add-ons, combining East Africa safari with one of the world's most beautiful islands.",
  },
  {
    q: "Do you offer fly-in safaris in Tanzania?",
    a: "Yes — charter flights into Serengeti, Ruaha and other remote parks are available. We handle all flight bookings as part of the package.",
  },
];
    ...
    <>
      ...
      <CountrySafariPage
        ...
        hero={{
          ...
          imageAlt:
            "Wildebeest crossing the Mara River in Tanzania's Serengeti",
          breadcrumbs: [
            { label: "Home", href: "/" },
          ...
          description:
            "Serengeti Great Migration tours, Ngorongoro Crater game drives, Tarangire elephant safaris and the option to finish on Zanzibar — every itinerary rewritable for your dates and budget.",
          stats: [
        ...
        packages={{
          ...
          heading: (
            <>
              Best-selling Tanzania{" "}
              <em className="italic text-bone-clay">itineraries</em>.
            </>
          ),
          description:
            "From short Ngorongoro crater visits to deep Serengeti migration circuits. Every package is rewritable — we'll tune the parks, lodges and timing to fit your group and goals.",
        ...
        choose={{
          ...
          description:
            "Tell us the wildlife or experience you're chasing and we'll combine the right parks into a seamless itinerary.",
          cells: [
          ...
          items: [
            {
              ...
              body: "Certified Tanzanian guides with deep knowledge of the Serengeti ecosystem and predator behaviour.",
            },
            {
              n: "02",
              title: "Tailor-made packages",
              body: "Every itinerary is built to match your budget, dates, pace and the wildlife you most want to see.",
            },
            {
              n: "03",
              title: "Fly-in options",
              body: "Charter flights into remote airstrips save hours of driving and get you deeper into pristine wildlife zones.",
            },
            {
              n: "04",
              title: "Transparent pricing",
              body: "No hidden fees and no surprise charges — honest, affordable quotes you can plan around.",
            },
            {
              n: "05",
              title: "24/7 support",
              body: "From first enquiry to airport drop-off and beyond, a real person is always reachable.",
            },
            {
              n: "06",
              title: "Migration expertise",
              body: "We know the herds' patterns and position you at the right place, at the right time.",
            },
          ],
        }}
        bestTime={{
          intro:
            "Tanzania rewards visitors all year. The best time depends entirely on the wildlife experience you're chasing — and we'll help you find the right window.",
          seasons: [
            {
        ...
        tailor={{
          ...
          description:
            "Your safari should be too. Tell us your travel dates and we'll build your perfect Tanzania trip — at whatever level of comfort suits you.",
          points: [
            {
              ic: "i",
              b: "Budget & mid-range lodge safaris",
              s: "great value without compromise",
            },
            {
              ic: "ii",
              b: "Luxury tented camps",
              s: "inside the park, under canvas",
            },
            {
              ic: "iii",
              b: "Migration-timed itineraries",
              s: "matched to the calendar of hooves",
            },
            {
              ic: "iv",
              b: "Photography safaris",
              s: "private vehicle, a guide who shoots",
            },
            {
              ic: "v",
              b: "Kenya–Tanzania combinations",
              s: "two countries, one seamless trip",
            },
          ],
          image:
            "https://images.pexels.com/photos/25950513/pexels-photo-25950513.jpeg?auto=compress&cs=tinysrgb&w=900&q=80",
        ...
        cta={{
          heading: (
            <>
              Let&apos;s build your Tanzania{" "}
              <em style={{ fontStyle: "italic", color: "#f4d4a8" }}>safari</em>.
            </>
          ),
          description:
            "Tell us your budget, dates, wildlife interests and who's travelling. Our experts choose the best parks, lodges and routes and send a free, no-obligation proposal — usually within half an hour.",
