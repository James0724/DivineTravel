...
export default async function AfricanTravelBlogPage({ searchParams }: Props) {
  ...
  return (
    <>
      ...
      <PageHero
        ...
        imageAlt="African Travel Blog — stories from East Africa"
        minHeight="min-h-[60vh]"
        breadcrumbs={[{ label: "Home", href: "/" }, { label: "African Travel Blog" }]}
        eyebrow="African Travel Blog"
        title={
          <>
            Stories from{" "}
      ...
      {featured && (
        <section className="bg-bone-bg pb-24 pt-2">
          <div className="container-site">
            <Reveal>
              <Link
                href={`/african-travel-blog/${featured.slug}`}
