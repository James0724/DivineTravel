...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    type: 'website',
    images: [{ url: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=1200&q=80', width: 1200, height: 630, alt: 'Uganda Safari' }],
  },
}
...
const data: DestinationPageData = {
  ...
  hero: {
    ...
    imageAlt: 'Mountain gorillas in Bwindi — Uganda',
    slug: 'uganda',
    title: (
      <>
        Uganda&apos;s wild
    ...
    stats: [
      { num: '~460', lbl: 'Mountain gorillas' },
      { num: '10', lbl: 'National parks' },
      { num: '1,000+', lbl: 'Bird species' },
    ],
  },

  why: {
    images: [
      { src: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=800&q=80', alt: 'Gorilla trekking Uganda' },
      { src: 'https://images.unsplash.com/photo-1589308154441-3db3e7b4e8c4?w=800&q=80', alt: 'Uganda wildlife' },
    ],
  ...
  packages: [
    { img: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=900&q=80', tag: 'Uganda · Gorilla', name: '4-Day Gorilla Trekking Safari', desc: 'Fly to Bwindi, trek to the gorillas, enjoy lodge accommodation in the forest.', parks: ['Bwindi Impenetrable'], from: '$1,850', days: '4D · 3N' },
    { img: 'https://images.unsplash.com/photo-1589308154441-3db3e7b4e8c4?w=900&q=80', tag: 'Uganda · Circuit', name: '8-Day Uganda Primate Circuit', desc: 'Gorillas in Bwindi, chimps in Kibale, tree lions in Queen Elizabeth.', parks: ['Bwindi', 'Kibale', 'Queen Elizabeth'], from: '$3,200', days: '8D · 7N' },
    { img: 'https://images.unsplash.com/photo-1501854140801-50d01698950b?w=900&q=80', tag: 'Uganda · Full circuit', name: '12-Day Complete Uganda Safari', desc: 'The ultimate Uganda experience — gorillas, chimps, savannah and Murchison Falls.', parks: ['Bwindi', 'Queen Elizabeth', 'Kibale', 'Murchison'], from: '$5,400', days: '12D · 11N' },
  ],
