/**
 * Divine Travel Nest Safaris — Database Seed Script
 * Usage: npm run seed
 *
 * Seeds:
 *  - 1 admin user
...
const safaris = [
  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1516426122078-c23e76319801?w=1200&q=80', publicId: 'divine-travel-nest-safaris/safaris/migration/01', alt: 'Wildebeest crossing Mara River' },
      { url: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=1200&q=80', publicId: 'divine-travel-nest-safaris/safaris/migration/02', alt: 'Elephant herd at sunset' },
    ],
    ...
    seo: {
      metaTitle: 'Great Wildebeest Migration Safari Kenya | Divine Travel Nest Safaris',
...

  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1534177616072-ef7dc120449d?w=1200&q=80', publicId: 'divine-travel-nest-safaris/safaris/serengeti/01', alt: 'Giraffe on Serengeti plains at golden hour' },
    ],
    ...
    seo: {
      metaTitle: 'Serengeti & Ngorongoro Crater Safari | Divine Travel Nest Safaris',
...

  {
    ...
    images: [
      { url: 'https://images.unsplash.com/photo-1589840700256-41c5d84ef38b?w=1200&q=80', publicId: 'divine-travel-nest-safaris/safaris/gorilla/01', alt: 'Mountain gorilla in Bwindi forest' },
    ],
    ...
    seo: {
      metaTitle: 'Uganda Gorilla Trekking Safari | Divine Travel Nest Safaris',
...

  {
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1547471080-7cc2caa01a7e?w=1200&q=80', publicId: 'divine-travel-nest-safaris/safaris/amboseli/01', alt: 'Elephant herd crossing at Amboseli with Kilimanjaro' }],
    category: ['wildlife'],
    ...
    seo: {
      metaTitle: 'Amboseli Elephant Safari Kenya | Kilimanjaro Views | Divine Travel Nest Safaris',
...

  {
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1504173010664-32509107de5c?w=1200&q=80', publicId: 'divine-travel-nest-safaris/safaris/kruger/01', alt: 'Kruger National Park savanna at sunrise' }],
    category: ['wildlife', 'adventure'],
    ...
    seo: {
      metaTitle: 'Kruger Safari & Panorama Route | South Africa | Divine Travel Nest Safaris',
...

  {
    ...
    images: [{ url: 'https://images.unsplash.com/photo-1526073733167-4f0f5afc5c90?w=1200&q=80', publicId: 'divine-travel-nest-safaris/safaris/rwanda-gorilla/01', alt: 'Mist-covered Virunga volcanoes Rwanda' }],
    category: ['gorilla', 'wildlife', 'adventure'],
    difficulty: 'moderate', maxGroupSize: 8, minGroupSize: 2, minAge: 15,
    bestSeason: ['January', 'February', 'June', 'July', 'August', 'September', 'December'],
    featured: true, active: true, rating: 4.9, reviewCount: 97,
    seo: {
      metaTitle: 'Rwanda Gorilla & Chimp Trekking Safari | Divine Travel Nest Safaris',
...
const testimonials = [
  ...
  },
  {
    ...
    body: 'Nothing prepares you for looking into a silverback\'s eyes from 3 metres away. The trek was tough but our guide and the porters were incredible. We cried — both of us. Divine Travel Nest sorted everything effortlessly and the mid-range lodge had gorgeous volcano views.',
  ...
  },
  {
    ...
    body: 'The elephant bulls were right next to our vehicle at sunrise with the mountain perfectly clear behind them. I have thousands of photos but none capture how it felt. Luxury tier was impeccable — outdoor bath, fire, Milky Way overhead. Divine Travel Nest are true professionals.',
  ...
  },
  {
    ...
    body: 'I was sceptical about Kruger being "too commercialised" but the private reserve bordering the park was wild and extraordinary. Four rhino sightings in two days. The guided walk with an armed ranger was thrilling. Divine Travel Nest\'s team were professional from first contact to farewell.',
  ...
  },
  {
    ...
    body: 'The gorilla trek, the Genocide Memorial, the women\'s weaving cooperatives — Rwanda moved us deeply on every level. The chimp tracking in Nyungwe was an unexpected highlight. Divine Travel Nest\'s seamless logistics let us focus entirely on being present. Book this trip.',
  ...
  },
  {
    ...
    body: 'As a solo female traveller I had concerns but Divine Travel Nest made everything comfortable. The budget group was a wonderful mix of nationalities. Our guide was knowledgeable, funny, and endlessly patient. The Mara sunrise will stay with me forever.',
    safariName: 'Great Wildebeest Migration Safari',
    featured: true, verified: true,
  },
  {
